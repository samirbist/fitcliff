...
CREATE TABLE public.customer_group (
	...
	CONSTRAINT group_membership_duration_check CHECK (((membership_duration)::text = ANY ((ARRAY['ONE_MONTH'::character varying, 'THREE_MONTHS'::character varying, 'SIX_MONTHS'::character varying, 'ONE_YEAR'::character varying])::text[])))
);
