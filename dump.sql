...
CREATE TABLE public.customer (
	...
	CONSTRAINT fklkies97eyvye3jidco7p4db1i FOREIGN KEY (group_id) REFERENCES public.customer_group(id),
	CONSTRAINT fklvkoymf59wc9e62dqsw534c5m FOREIGN KEY (image_id) REFERENCES public.image(id),
	CONSTRAINT fknrlkv5c82igy36jhi38c72afu FOREIGN KEY (document_id) REFERENCES public."document"(id)
);
...
CREATE TABLE public.group_payment (
	...
	CONSTRAINT fkopr9j3ujuefu2rexb2g7npo3p FOREIGN KEY (group_id) REFERENCES public.customer_group(id)
);
...
CREATE TABLE public.ind_customer_payment (
	...
	CONSTRAINT fkchcefiapdc3kjko1rqah7kdv FOREIGN KEY (customer_id) REFERENCES public.customer(id)
);
...
CREATE TABLE public.phone (
	...
	CONSTRAINT fkfprk2x6ho4vkgolggdqu9ogqc FOREIGN KEY (customer_fk) REFERENCES public.customer(id)
);
